...
def init_defaults():
    ...
    existing_admins = data_service.get_setting("system_admin_phone_numbers")
    ...
    if existing_admins:
        ...
        if default_admin_phone not in admin_set:
            ...
            data_service.set_setting("system_admin_phone_numbers", updated_value)
        ...
        data_service.set_setting("system_admin_phone_numbers", default_admin_phone)
