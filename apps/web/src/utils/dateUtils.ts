...
/**
 * Relative time formatting is centralized in @beach-kings/shared so web and
 * mobile share one implementation. Re-exported here so existing web imports
 * (`@/utils/dateUtils`) keep working unchanged; default style is 'long'.
 */
export {
  formatRelativeTime,
