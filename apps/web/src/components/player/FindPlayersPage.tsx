 ...
 */
function FriendBadge({ friendStatuses, playerId }: FriendBadgeProps) {
 ...
 */
function getFilterDisplayValue(key: string, value: string) {
 ...
 */
function SortableHeader({ label, columnKey, sortBy, sortDir, onSort }: SortableHeaderProps) {
