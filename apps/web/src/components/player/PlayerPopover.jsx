 ...
 *
 * @param {Object} props
 * @param {number|null} props.playerId - Player ID to show actions for
 * @param {string} props.playerName - Display name
 * @param {DOMRect} props.anchorRect - getBoundingClientRect() of the clicked element
 * @param {Function} props.onClose - Called when popover should dismiss
 * @param {Object} [props.friendStatusCache] - Shared cache: { [playerId]: status string }
 * @param {Function} [props.onCacheUpdate] - Called with (playerId, status) when status changes
 */
