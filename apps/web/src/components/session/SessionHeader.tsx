...
export default function SessionHeader({ sessionName, gameCount, playerCount, isEditing = false, onStatsClick, onRequestDelete, onRequestLeave }: SessionHeaderProps) {
