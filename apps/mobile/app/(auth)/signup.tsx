      ...
      >
        ...
        <View className="gap-sm mb-md">
          ...
          >
            ...
            <Text className="font-semibold text-body text-default">Sign Up with Google</Text>
          </Pressable>
          ...
          {showApple && (
            ...
            >
              ...
              <Text className="font-semibold text-body" style={{ color: appleFg }}>Sign Up with Apple</Text>
            </Pressable>
          )}
        </View>
