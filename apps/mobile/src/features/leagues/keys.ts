...
/** User-scoped Query keys for league lists, details, and related screens. */
export const leagueKeys = {
  ...
  standings: (
    ...
    [
      ...leagueKeys.league(userId, id),
      'standings',
      seasonId ?? 'current',
    ] as const,
  seasons: (userId: number, id: number | string) =>
    [...leagueKeys.league(userId, id), 'seasons'] as const,
  sessions: (userId: number, id: number | string) =>
    [...leagueKeys.league(userId, id), 'sessions'] as const,
  ...
  playerStats: (
    ...
    [
      ...leagueKeys.league(userId, leagueId),
      'playerStats',
      String(playerId),
      seasonId ?? 'current',
    ] as const,
