    ...
    async with AsyncSessionLocal() as session:
        ...
        if existing_admins:
            ...
            if default_admin_phone not in admin_set:
                ...
                await data_service.set_setting(session, "system_admin_phone_numbers", updated_value)
            ...
            await data_service.set_setting(session, "system_admin_phone_numbers", default_admin_phone)
