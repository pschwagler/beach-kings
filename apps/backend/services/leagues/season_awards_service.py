...
STAT_AWARD_DEFS = [
    ...
    {"key": "sharpshooter", "stat": "win_rate"},
    {"key": "point_machine", "stat": "avg_pt_diff"},
...
async def _notify_winners(
    ...
    from backend.services.notifications.notification_service import create_notifications_bulk
