...
from backend.services.leagues.league_data import is_league_member
from backend.services.players.player_data import generate_player_initials
...
async def _build_league_player_game_history(
    ...
    """
    from backend.services.games.my_games_service import _build_entry
...
async def get_league_player_stats_full(
    ...
    return {
        ...
        "is_self": (current_user_player_id is not None and current_user_player_id == player.id),
    }
